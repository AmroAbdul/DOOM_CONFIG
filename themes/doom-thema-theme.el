;;; doom-thema-theme.el --- inspired by the popular Thema theme -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup doom-thema-theme nil
  "Options for the `Thema' theme."
  :group 'doom-themes)

(defcustom doom-thema-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-thema-theme
  :type 'boolean)

(defcustom doom-thema-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-thema-theme
  :type 'boolean)

(defcustom doom-thema-colorful-headers nil
  "If non-nil, headers in org-mode will be more colorful; which is truer to the
original Thema Emacs theme."
  :group 'doom-thema-theme
  :type 'boolean)

(defcustom doom-thema-comment-bg doom-thema-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-thema-theme
  :type 'boolean)

(defcustom doom-thema-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-thema
  "A dark theme based on Thema theme"

  ;; name        default   256       16
  ((bg         '("#08020A" "#363537" "black"        ))
   (bg-alt     '("#1E2029" "#1c1c1c" "black"        ))
   (base0      '("#1E2029" "#1c1c1c" "black"        ))
   (base1      '("#08020A" "#363537" "brightblack"  ))
   ...
   (base8      '("#D6E2FF" "#F7F9FF" "white"        ))
   (fg         '("#D6E2FF" "#F7F9FF" "white"        ))
   (fg-alt     '("#e2e2dc" "#bfbfbf" "brightwhite"  ))

   (grey       base4)
   (red        '("#ff5555" "#FF8686" "red"          ))
   (orange     '("#ffb86c" "#EDCAA5" "brightred"    ))
   (green      '("#2D882D" "#69f15c" "green"        ))
   (teal       '("#0189cc" "#0088cc" "brightgreen"  ))
   (yellow     '("#f1fa8c" "#E7FA4D" "yellow"       ))
   (blue       '("#08020A" "#66bbff" "brightblue"   ))
   (dark-blue  '("#0189cc" "#0088cc" "blue"         ))
   (magenta    '("#ff79c6" "#ff77cc" "magenta"      ))
   (violet     '("#bd93f9" "#927FA1" "brightmagenta"))
   (cyan       '("#0F949E" "#63A7AD" "brightcyan"   ))
   (dark-cyan  '("#0F949E" "#88eeff" "cyan"         ))
   ...
   (selection      dark-blue)
   (builtin        orange)
   (comments       (if doom-thema-brighter-comments dark-cyan base5))
   (doc-comments   (doom-lighten (if doom-thema-brighter-comments dark-cyan base5) 0.25))
   (constants      cyan)
   (functions      green)
   (keywords       magenta)
   (methods        teal)
   ...
   (level1 magenta)
   (level2 violet)
   (level3 (if doom-thema-colorful-headers green   (doom-lighten violet 0.35)))
   (level4 (if doom-thema-colorful-headers yellow  (doom-lighten magenta 0.35)))
   (level5 (if doom-thema-colorful-headers cyan    (doom-lighten violet 0.6)))
   (level6 (if doom-thema-colorful-headers orange  (doom-lighten magenta 0.6)))
   (level7 (if doom-thema-colorful-headers blue    (doom-lighten violet 0.85)))
   (level8 (if doom-thema-colorful-headers magenta (doom-lighten magenta 0.85)))
   (level9 (if doom-thema-colorful-headers violet  (doom-lighten violet 0.95)))

   (-modeline-bright doom-thema-brighter-modeline)
   (-modeline-pad
    (when doom-thema-padded-modeline
      (if (integerp doom-thema-padded-modeline) doom-thema-padded-modeline 4)))
  ...
  (((line-number &override) :foreground base5)
   ...
   ((font-lock-comment-face &override)
    :background (if doom-thema-comment-bg (doom-lighten bg 0.05) 'unspecified))
   (mode-line
