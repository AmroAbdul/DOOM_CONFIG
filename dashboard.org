...
ُ
[[file:./splash/]]doom-emacs-arabic-logo.svg

⦿ *IMPORTANT KEYBINDINGS* *اختصارات مهمة*
|------------+---------------------+------------------------------------|
...
⦿ *HELP INFORMATION* *معلومات المساعدة*
|-----------------------------+-----------------------------+-------------------------------|
...
⦿ *DOOM EMACS CONFIGS* (Press =1-5= to immediately open a file) *إعدادات دووم إيماكس*
|---+----------------+------------------------------------------------------------|
